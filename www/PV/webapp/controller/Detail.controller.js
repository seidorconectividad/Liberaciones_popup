...
sap.ui.define([
    ...
    "com/prodac/libpedven/masterdetail/controller/jquery.soap",
    "com/prodac/libpedven/masterdetail/controller/xml2json",
    "sap/ui/commons/MessageBox"
], function(BaseController, JSONModel, formatter, History, Soap, xml2json, MessageBox) {
    "use strict";

    return BaseController.extend("com.prodac.libpedven.masterdetail.controller.Detail", {
        ...
        onAprobar: function(sComentario) {
            ...
            var wdsl = ['<soap:Envelope xmlns:soap="http://www.w3.org/2003/05/soap-envelope" xmlns:urn="urn:sap-com:document:sap:rfc:functions">',
                ...
                '</E_GTD_PED_AD>',
                '<I_CODE>' + '</I_CODE>',
                '<I_COMMENT>' + sComentario + '</I_COMMENT>',
                '<I_DLV_BLOCK>' + '</I_DLV_BLOCK>',
                '<I_SALESDOCUMENT>' + sNumlib + '</I_SALESDOCUMENT>',
                '</urn:Z_SD_SET_PED_APR_DES>',
                '</soap:Body>',
                '</soap:Envelope>'
            ];
            ...
            // 'https://destinations-d040c3179.dispatcher.us2.hana.ondemand.com/destinations/SAPDEV_RFC/sap/bc/srt/rfc/sap/zws_sd_set_ped_apr_des/130/zservice_zws_sd_set_ped_apr_des/zbinding_zws_sd_set_ped_apr_des',
            $.soap({
                url: 'https://destinations-d040c3179.dispatcher.us2.hana.ondemand.com/destinations/SAPDEV_RFC/sap/bc/srt/rfc/sap/zws_sd_set_ped_apr_des/100/zws_sd_set_ped_apr_des/zws_sd_set_ped_apr_des',
                data: wdsl.join(''),
                async: true,
                soap12: true,
                context: this,
                ...
                success: function(soapResponse) {
                    ...
                    var json2 = json["#document"]["env:Envelope"]["env:Body"]["n0:Z_SD_SET_PED_APR_DESResponse"]["E_GTD_PED_AD"];
                    console.log("onAprobar = ", json2);
                    console.log("Estado = ", json2["item"]["TYPE"]);

                    if (json2["item"]["TYPE"] == 'S') {
                        console.log("Se aprobó con éxito la liberación pedven");
                        ...
                        this.getView().getModel().update(sRequest, oCabecera, {
                            success: function(oData, oResponse) {
                                ...
                                midata.refresh(true);
                                sap.m.MessageToast.show("Se aprobó con éxito la liberación pedido venta", { duration: 6000 });
                            },
        ...
        onDesaprobar: function(sComentario) {
            ...
            var wdsl = ['<soap:Envelope xmlns:soap="http://www.w3.org/2003/05/soap-envelope" xmlns:urn="urn:sap-com:document:sap:rfc:functions">',
                ...
                '</item>',
                '</E_GTD_PED_AD>',
                '<I_CODE>' + sComentario + '</I_CODE>',
                '<I_COMMENT>' + '</I_COMMENT>',
                '<I_DLV_BLOCK>' + 'Z3' + '</I_DLV_BLOCK>',
                '<I_SALESDOCUMENT>' + sNumlib + '</I_SALESDOCUMENT>',
                '</urn:Z_SD_SET_PED_APR_DES>',
                '</soap:Body>',
                '</soap:Envelope>'
            ...
            $.soap({
                ...
                success: function(soapResponse) {
                    ...
                    if (json2["item"]["TYPE"] == 'S') {
                        console.log("Se desaprobó con éxito la liberación pedven");
                        ...
                        this.getView().getModel().update(sRequest, oCabecera, {
                            success: function(oData, oResponse) {
                                ...
                                sap.ui.core.BusyIndicator.hide();
                                midata.refresh(true);
                                sap.m.MessageToast.show("Se desaprobó con éxito la liberación pedido venta", { duration: 6000 });
                            },
                            error: function(oError) {
                                console.log("No se pudo cambiar el estado de la Liberación", oError);
                                sap.ui.core.BusyIndicator.hide();
